...
@else
    <div class="overflow-auto border rounded shadow-sm">
        <table class="min-w-full table-auto">
            <thead class="bg-indigo-700 text-white text-sm">
                <tr>
                ...
                @foreach ($data as $item)
                    <tr class="border-t">
                        ...
                        <td class="px-4 py-2 whitespace-nowrap space-x-2">
                            <a href="{{ route('iph-bulanan.edit', $item->id) }}" class="text-blue-600 hover:underline">Edit</a>
                            <a href="{{ route('iph-bulanan.delete', $item->id) }}" onclick="return confirm('Yakin ingin menghapus data ini?')" class="text-red-600 hover:underline">Hapus</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
