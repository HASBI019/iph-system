...
@section('content')
    <h2 class="text-2xl font-bold mb-6">Data IPH Mingguan</h2>

    {{-- Filter Tahun & Bulan --}}
    <form method="GET" action="/admin/iph/view-mingguan" class="mb-6 flex space-x-4">
                    ...
                    @foreach ($data as $item)
                        <tr class="border-t">
                            ...
                            <td class="px-4 py-2 space-x-2">
                                <a href="/admin/iph/edit-mingguan/{{ $item->id }}" class="text-blue-600 hover:underline">Edit</a>
                                <a href="/admin/iph/delete-mingguan/{{ $item->id }}" onclick="return confirm('Hapus data ini?')" class="text-red-600 hover:underline">Hapus</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
