    ...
    <table class="min-w-full text-sm text-left text-gray-700">
        ...
        <tbody class="bg-white">
            ...
            <tr class="border-t hover:bg-gray-50">
                ...
                <td class="px-3 py-2">{{ $item->minggu_ke }}</td>
                ...
                <td class="px-3 py-2 whitespace-nowrap space-x-2">
                    <a href="{{ route('iph-mingguan.edit', $item->id) }}" class="text-blue-600 hover:underline text-xs">Edit</a>
                    <a href="{{ route('iph-mingguan.delete', $item->id) }}" onclick="return confirm('Yakin ingin menghapus data ini?')" class="text-red-600 hover:underline text-xs">Hapus</a>
                </td>
            </tr>
            @endforeach
        </tbody>
